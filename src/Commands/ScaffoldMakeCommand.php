...
namespace veyselsahin\l5generators\Commands;

use Illuminate\Console\AppNamespaceDetectorTrait;
use Illuminate\Console\Command;
use Illuminate\Filesystem\Filesystem;
use Illuminate\Foundation\Composer;
use veyselsahin\l5generators\Makes\MakeController;
use veyselsahin\l5generators\Makes\MakeLayout;
use veyselsahin\l5generators\Makes\MakeMigration;
use veyselsahin\l5generators\Makes\MakeModel;
use veyselsahin\l5generators\Makes\MakerTrait;
use veyselsahin\l5generators\Makes\MakeSeed;
use veyselsahin\l5generators\Makes\MakeView;
...
class ScaffoldMakeCommand extends Command
{
    ...
    public function fire()
    {
        ...
        $this->meta['table'] = $this->getObjName("name"); // Store table name
    ...
    private function makeViews()
    {
        ...
        Cache::forget("result_route");
        Cache::put("result_route", 'Route::resource("' . $this->getObjName("names") . '","' . $this->getObjName("Name") . 'Controller");',5);
        $this->info('Route::resource("' . $this->getObjName("name") . '","' . $this->getObjName("Name") . 'Controller"); // Add this line in routes.php');
